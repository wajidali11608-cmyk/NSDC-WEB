...
const UPCOMING = [
  {
    ...
    loc: "Campus HQ · TBA",
    desc: "A weekend-long sprint to build high-performance systems, decentralized applications, and intelligent agents.",
    cta: "Notify Me",
  },
  {
    n: "02",
    ...
    title: "Brainhack 2.0",
    type: "Hackathon",
    division: "Data Science × Tech",
    loc: "Main Auditorium · TBA",
    desc: "Push the boundaries of intelligent systems, deep learning, and generative logic in a high-intensity hackathon.",
    cta: "Notify Me",
  },
  {
    n: "03",
    date: "TBA · 2026",
    day: "TBD",
    title: "Kinetic Web Intensive",
    type: "Workshop",
    division: "Tech × Creative",
    loc: "Virtual Labs · TBA",
    desc: "A rigorous 3-day workshop series covering intermediate full-stack frameworks, design token orchestration, and interactive typography.",
    cta: "Notify Me",
  },
];

const PAST = [
  { n: "006", title: "Git & GitHub Foundation", tag: "Workshop", date: "FEB 2026", team: "Tech" },
  { n: "005", title: "Python for Data Science", tag: "Programming", date: "JAN 2026", team: "Tech × Data Science" },
  { n: "004", title: "Brainhack Ideathon", tag: "Hackathon", date: "NOV 2025", team: "Data Science × Tech" },
  { n: "003", title: "Snapchat Augmented Reality", tag: "Augmented Reality", date: "OCT 2025", team: "Media × Tech" },
  { n: "002", title: "AI/ML Workshop from Scratch", tag: "Workshop", date: "OCT 2025", team: "Data Science" },
  { n: "001", title: "Building Apps using Gen AI", tag: "Generative AI", date: "OCT 2025", team: "Data Science × Tech" },
];
